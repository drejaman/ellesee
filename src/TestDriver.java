...
public class TestDriver {
	public static void main(String[] args) throws Exception {
		//bst.TestBST tester = new bst.TestBST();
//		bitManipulate.TestBit tester = new bitManipulate.TestBit();
		//oopDesign.TestOOP tester = new oopDesign.TestOOP();
		//recursion.TestRecursion tester = new recursion.TestRecursion();
		//epic.TestEpic tester = new epic.TestEpic();
		//sorting.TestSorting tester = new sorting.TestSorting();
